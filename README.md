...
- Edit submits `FormData` with name, description, category, product type, stock, customizable flag, base price, HSN code, GST percentage, optional image, and sorted `quantityPricing`.
...
- Requires name, price, description, active category, base price, at least one image, and valid quantity pricing. Includes a real-time Price & Tax Calculation preview (inclusive of GST).
